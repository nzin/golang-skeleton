...
//go:generate swagger generate server --target ../../swagger_gen --name golang-skeleton --spec ../../docs/api_docs/bundle.yaml

func configureFlags(api *operations.GolangSkeletonAPI) {
	// api.CommandLineOptionsGroups = []swag.CommandLineOptionsGroup{ ... }
}

func configureAPI(api *operations.GolangSkeletonAPI) http.Handler {
